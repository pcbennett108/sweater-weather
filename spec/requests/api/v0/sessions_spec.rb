  ...
  describe 'POST /api/v0/sessions' do
    ...
    context 'With valid login credentials' do
      it 'starts a session and returns the email/ api_key for the user' do
        user = User.create!(email: "marge@springfield.com", password: "password", password_confirmation: "password")
        params = {
    ...
    context 'With invalid login credentials' do
      it 'returns a generic error for invalid email' do
        User.create!(email: "lisa@springfield.com", password: "password", password_confirmation: "password")
        params = {
          "email": "someone@springfield.com",
          "password": "password"
        }
        headers = {"CONTENT_TYPE" => "application/json"}
      ...
      it 'returns a generic error for invalid password' do
        user = User.create!(email: "homer@springfield.com", password: "password", password_confirmation: "password")
        params = {
